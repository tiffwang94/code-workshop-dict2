...
def add_to_shopping_list(shopping_dict, list_name, items):
    ...
    Returns:
      None
    """
    shopping_dict[list_name].extend(item)
...
def remove_from_shopping_list(shopping_dict, list_name, items):
    ...
    for item in items:
        if item in shopping_dict[list_name]:
            shopping_dict[list_name].remove(item)

        else:
            print "{} not in the {} list. Can't remove.".format(item, list_name)
...
def show_all_lists(shopping_dict):
    ...
    Returns:
      None
    """
    for list_name in shopping_dict:
        shopping_lists_by_name(shopping_dict, list_name)
